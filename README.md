...
*Note to Windows users: although this project is **not** Unix-specific, Windows support will not be guaranteed due to the instability of continuous integration (see https://github.com/val-lang/val/issues/252).*
