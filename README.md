...
**Windows users:** 
1. Although this project is **not** Unix-specific, Windows support is not guaranteed due to the instability of continuous integration (see [issue 252](https://github.com/hylo-lang/hylo/issues/252) and [Swifty-LLVM/issues 24](https://github.com/hylo-lang/Swifty-LLVM/issues/24)).
