...
*Note to Windows users: although this project is **not** Unix-specific, Windows support is not guaranteed due to the unexpected continuous integration failure (see https://github.com/val-lang/val/issues/805).*
