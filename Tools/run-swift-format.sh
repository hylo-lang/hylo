...
TARGETS_ARGS="--target CLI --target ValCommand --target FrontEnd --target Core --target IR --target CodeGenLLVM --target ValModule --target Utils --target UtilsTests --target ValTests --target ValCommandTests"
