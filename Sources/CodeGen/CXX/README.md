...
The translation between Val AST and CXX AST is done in `CXXTranspiler` class.
At this stage, we are looking at AST transformation and we completely ignore the format of the CXX code.

The `CXXCodeWriter` class takes a CXX AST and produces actual CXX code, in a textual form.
