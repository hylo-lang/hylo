...
extension AST {
  ...
  func validateGlobalScopeMember(
    ...
    case AssociatedTypeDecl.self:
      diagnostics.report(.diagnose(unexpectedAssociatedTypeDecl: self[NodeID(rawValue: decl.rawValue)]))

    case AssociatedValueDecl.self:
      diagnostics.report(.diagnose(unexpectedAssociatedValueDecl: self[NodeID(rawValue: decl.rawValue)]))
    ...
    case InitializerDecl.self:
      diagnostics.report(.diagnose(unexpectedInitializerDecl: self[NodeID(rawValue: decl.rawValue)]))
    ...
    case SubscriptImplDecl.self:
      diagnostics.report(.diagnose(unexpectedSubscriptImplDecl: self[NodeID(rawValue: decl.rawValue)]))
