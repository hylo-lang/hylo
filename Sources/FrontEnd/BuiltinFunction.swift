...
public enum BuiltinFunction: Hashable {
  ...
  case tocint(hyloIntegerType: BuiltinType, targetCType: BuiltinCNumericType, sourceTypeSigned: Bool)
...
extension BuiltinFunction {
  ...
  public init?(_ n: String) {
    ...
    case "tocint":
      ...
      self = .tocint(hyloIntegerType: fromType, targetCType: cIntType, sourceTypeSigned: isSized == "s")
