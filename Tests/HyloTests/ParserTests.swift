...
final class ParserTests: XCTestCase {
  ...
  func testConditionalControlNotOperatorOnFalse() throws {
    ...
    XCTAssertEqual(stmt.expansion(for: ConditionalCompilationConfiguration()).count, 1)
  }
  ...
  func testConditionalControlNotOperatorOnTrue() throws {
    ...
    XCTAssertEqual(stmt.expansion(for: ConditionalCompilationConfiguration()).count, 0)
  }
